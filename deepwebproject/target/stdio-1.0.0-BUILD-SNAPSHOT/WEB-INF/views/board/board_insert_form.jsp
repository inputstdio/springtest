...
<link rel="stylesheet" href="resources/css/board_insert_form.css">
</head>
<body>
	<form id="boardInsert" name="boardInsert" action="boardInsert" method="post" data-parsley-validate enctype="multipart/form-data">
		<div class="container" style="text-align: center;">
			<div class="row" style="margin-top: 10%; margin-bottom: 2%;">
				<div class="col-md-2"></div>
				<div class="col-md-8">
					<span class="title"><i class="fas fa-edit"> Board Write Page</i></span>
				</div>
				<div class="col-md-2"></div>
			</div>
			<div class="row">
				...
				<div class="col-md-8" style="padding-top: 2%; padding-bottom: 2%; border: 3px solid white; border-radius: 7px;">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fas fa-dice-d6"> Title</i></span><input id="b_title" type="text" class="form-control" name="b_title" required="required" placeholder="Enter Title">
					</div>
					<div class="input-group">
